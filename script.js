...
let isOpenRace = false; // Defina o estado inicial como fechado
...
raceSelect.addEventListener('change', function () {
    ...
    switch (selectedRace) {
        case 'human':
            raceTitle = 'Humano';
            raceDescription = 'Humans are a versatile race known for their adaptability and ambition. They are found in various societies and environments, excelling in diverse fields.</br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +1 em dois atributos diferentes</br><b>Tamanho:</b> Médio</br><b>Deslocamento:</b> 9m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, +1 à sua escolha.</br></br><b>Perícia:</b> Proficiência em uma perícia, à sua escolha.</br><b>Talentoso:</b> Adquire um talento de sua escolha.';
            break;
        case 'dragonborn':
            raceTitle = 'Draconato';
            raceDescription = 'Descendentes de dragões, como seus nomes demonstram, os draconatos andam orgulhosamente pelo mundo que os saúda com um temor incompreensível. Moldados por deuses dracônicos ou pelos próprios dragões, draconatos originalmente nasceram de ovos de dragão como uma raça única, combinando os melhores atributos de dragões e humanos. Alguns draconatos são servos fieis de dragões verdadeiros, outros formas as fileiras de soldados em grandes guerras e ainda existem os que encontram-se à toa, sem um objetivo claro na vida.</br></br>Draconatos parecem muito com dragões que estão de pé em forma humanoide, apesar de não possuírem asas nem uma calda. O primeiro draconato possuía escamas de matizes brilhantes combinando com as cores do dragão de que descendia, mas gerações de misturas criaram uma aparência mais uniforme. Suas pequenas escamas finas, normalmente são de cor bronze ou latão, algumas vezes indo até tons de escarlate, ferrugem, ouro ou cobre esverdeado. Eles são altos e de constituição forte, muitas vezes medindo 1,95 metro de altura e pesando 150 kg ou mais. Suas mãos e pés são fortes, com três dedos de garras curvadas em cada mão. </br></br><h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +2 de FOR, +1 de CAR<br><b>Tamanho:</b> Médio<br><b>Deslocamento:</b> 9m<br><b>Visão no Escuro:</b> 18m<br><b>Idiomas:</b> Comum, Dracônico.<br><br><b>Ancestral Dracônico:</b> Escolha um tipo de dragão da tabela Ancestral Dracônico. Sua arma de sopro e resistência a dano são determinadas pelo tipo de dragão, como mostrado na tabela abaixo.<br><b>Arma de Sopro:</b> Pode usar uma ação para exalar energia destrutiva. A CD do teste de resistência é 8 + seu modificador de CON + bônus de proficiência. Uma criatura sofre 2d6 de dano num fracasso e metade desse dano num sucesso. O dano aumenta para 3d6 no 6° nível, 4d6 no 11° nível e 5d6 no 16° nível. Depois de usar a arma de sopro, você não poderá utilizá-la novamente até completar um descanso curto ou longo.<br><b>Resistência a Dano:</b> Você possui resistência ao tipo de dano associado ao seu ancestral dracônico.</br></br>';
            racetable = '<table style="border-collapse: collapse; width: 100%;"> <tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"><b> Ancestral</b> </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> <b>Tipo de Dano</b> </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> <b>Arma de Sopro</b> </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> <b>Salvaguarda</b> </td> </tr> <tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Azul </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Fogo </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Linha - 1.5m/9m </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> DES </td> </tr> <tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Branco </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Frio </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cone - 4.5m </td> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> CON </td> </tr> <tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Bronze </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Elétrico </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Linha - 1.5m/9m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> DES </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cobre </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Ácido </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Linha - 1.5m/9m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> DES </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Latão </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Fogo </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Linha - 1.5m/9m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> DES </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Negro </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Fogo </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Linha - 1.5m/9m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> DES </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Ouro </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Fogo </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cone - 4.5m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> CON </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Prata </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Gelo </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cone - 4.5m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> CON </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Verde </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Veneno </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cone - 4.5m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> CON </td></tr><tr> <td style="border: 1px solid #DFDFDF; padding: 5pt;"> Vermelho </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Veneno </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> Cone - 4.5m </td><td style="border: 1px solid #DFDFDF; padding: 5pt;"> CON </td></table>'
            break;
        case 'dwarf':
            raceTitle = 'Anão';
        ...
        case 'gnome':
            raceTitle = 'Gnomo';
            raceDescription = 'Gnomes are small, clever humanoids with a knack for inventing and an affinity for illusions. </br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +2 de INT</br><b>Tamanho:</b> Pequeno</br><b>Deslocamento:</b> 7.5m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, Gnômico.</br></br><b>Esperteza Gnômica:</b> Vantagem em todas as salvaguardas de INT, SAB e CAR contra magia.</br></br><b>Ancestralidades:</b> Gnomo da Floresta ou Gnomo das Rochas.</br></br><h4>Gnomo da Floresta</h4><b>Aprimoramento de Atributo:</b> +1 de DES</br><b>Ilusionista Nato:</b> : Conhece o truque Ilusão Menor. INT é o atributo de conjuração.</br><b>Falar com Bestas Pequenas:</b> Através de sons e gestos, você pode comunicar ideias simplespara Bestas pequenas ou menores.</br></br><h4>Gnomo das Rochas</h4><b>Aprimoramento de Atributo:</b> +1 de CON</br><b>Conhecimento Artífice:</b> Considerado proficiente em História (INT) ao realizar um testerelacionado a itens mágicos, objetos alquímicos ou mecanismos tecnológicos. O bônus édobrado no teste.</br><b>Engenhoqueiro:</b> Proficiência com ferramentas de artesão (ferramentas de engenhoqueiro).Usando essas ferramentas, você pode gastar 1h e 10po em materiais para construir ummecanismo Miúdo (CA 5, 1PV). O mecanismo para de funcionar após 24 horas (a não ser quevocê gaste 1h reparando-o para manter o mecanismo funcionando), ou quando você usa suaação para desmantelá-lo; nesse momento, você pode recuperar o material usado para criá-lo.Você pode ter até três desses mecanismos ativos ao mesmo tempo. Quando você criar ummecanismo, escolha uma das seguintes opções:</br></br>• Brinquedo Mecânico. Esse brinquedo é um animal, monstro ou pessoa mecânica, comoum sapo, rato, pássaro, dragão ou soldado. Quando colocado no chão, o brinquedo semove 1.5m pelo chão em cada um dos seus turnos em uma direção aleatória. Ele fazbarulhos apropriados a criatura que ele representa.</br>• Isqueiro Mecânico. O mecanismo produz uma miniatura de chama, que você pode usarpara acender uma vela, tocha ou fogueira. Usar o mecanismo requer sua ação.</br>• Caixa de Música. Quando aberta, essa caixa de música toca uma canção a um volumemoderado. A caixa para de tocar quando alcança o fim da música ou quando é fechada.</br>';
            break;
        case 'halfelf':
            raceTitle = 'Meio-Elfo';
            raceDescription = 'Half-Elves are a hybrid race with human and elven ancestry, often having the best qualities of both races. </br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +1 em dois atributos diferentes</br><b>Tamanho:</b> Médio</br><b>Deslocamento:</b> 9m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, +1 à sua escolha.</br></br><b>Perícia:</b> Proficiência em uma perícia, à sua escolha.</br><b>Talentoso:</b> Adquire um talento de sua escolha.';
            break;
        case 'halfling':
            raceTitle = 'Pequenino';
            raceDescription = 'Halflings are small and nimble folk known for their love of comfort, food, and a simple, happy life. </br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +2 de DES</br><b>Tamanho:</b> Pequeno</br><b>Deslocamento:</b> 7.5m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, +1 à sua escolha.</br></br><b>Perito:</b> Proficiência em uma perícia, à sua escolha.</br><b>Bravura:</b> Vantagem em salvaguardas contra ficar amedrontado.</br><b>Agilidade:</b> Você pode mover-se através do espaço de qualquer criatura que for de umtamanho maior que o seu.</br></br><b>Ancestralidades:</b> Pés-Leves ou Robusto.<h4>Pés-Leves</h4><b>Aprimoramento de Atributo:</b> +1 de CAR</br><b>Furtividade Natural:</b> Você pode tentar se esconder mesmo quando possuir apenas acobertura de uma criatura que for no mínimo um tamanho maior que o seu.</br><h4>Robusto</h4><b>Aprimoramento de Atributo:</b> +1 de CON</br><b>Resiliência:</b> Vantagem em salvaguardas contra veneno e resistência à veneno.';
            break;
        case 'halforc':
            raceTitle = 'Meio-Orc';
            raceDescription = 'Half-Orcs are strong and robust, born of human and orc parentage, often possessing both races strengths. </br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +2 de FOR, +1 de CON.</br><b>Tamanho:</b> Médio</br><b>Deslocamento:</b> 9m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, Orc.</br></br><b>Ameaçador:</b> Proficiência na perícia Intimidação.</br><b>Resistência Implacável:</b> Quando for reduzido a 0PV, mas não morrer, você pode voltar para1PV instantaneamente. Você não pode usar essa característica novamente até completar umdescanso longo.</br><b>Ataques Selvagens:</b> Quando você atinge um ataque crítico com uma arma corpo-a-corpo,você pode rolar um dos dados de dano da arma mais uma vez e adicioná-lo ao dano extracausado pelo acerto crítico.';
            break;
        case 'tiefling':
            raceTitle = 'Tiferino';
            raceDescription = 'Tieflings are descendants of fiends, with infernal traits and a struggle against their dark ancestry.</br></br> <h3>Traços de Ascendência</h3><b>Aprimoramento de Atributo:</b> +2 de CAR, +1 de INT</br><b>Tamanho:</b> Médio</br><b>Deslocamento:</b> 9m</br><b>Visão no Escuro:</b> 18m</br><b>Idiomas:</b> Comum, Infernal.</br></br><b>Resistência Ínfera:</b> Resistência à fogo.</br><b>Bravura:</b> Vantagem em salvaguardas contra ficar amedrontado.</br><b>Legado Infernal:</b> Possui o truque Taumaturgia. No 3ºNvl pode conjurar Repreensão Infernalcomo segundo círculo, no 5ºNvl pode conjurar Escuridão. Ao conjurar essas magias, énecessário um descanso longo para usá-las novamente. CAR é o atributo de conjuração.';
            break;
        case 'customrace':
...
if (!isOpenRace) {
    // Ocultar todos os elementos div, h3, h4 e p dentro do raceDescriptionDiv
    raceDescriptionDiv.querySelectorAll('div, h3, h4, p').forEach(element => {
        element.style.display = 'none';
    });

    // Adicionar a classe de estilo fechado
    raceDescriptionDiv.classList.add('closed-description');
}

});

// Adicione um ouvinte de eventos ao elemento para alternar a visibilidade da descrição
raceDescriptionDiv.addEventListener('click', function () {
    const descriptionElements = raceDescriptionDiv.querySelectorAll('div, h3, h4, p');
    descriptionElements.forEach(element => {
        element.style.display = isOpenRace ? 'none' : 'block';
    });

    isOpenRace = !isOpenRace;
    raceDescriptionDiv.classList.toggle('closed-description'); // Toggle a classe
});

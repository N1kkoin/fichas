...
raceSelect.addEventListener('change', function () {
    ...
    switch (selectedRace) {
        ...
        case 'dragonborn':
            ...
            racetable = '<div class="table"> <div class="row"> <div class="cell"><b>Ancestral</b></div> <div class="cell"><b>Tipo de Dano</b></div> <div class="cell"><b>Arma de Sopro</b></div> <div class="cell"><b>Salvaguarda</b></div> </div> <div class="row"> <div class="cell">Azul</div> <div class="cell">Fogo</div> <div class="cell">Linha - 1.5m/9m</div> <div class="cell">DES</div> </div> <div class="row"> <div class="cell">Branco</div> <div class="cell">Frio</div> <div class="cell">Cone - 4.5m</div> <div class="cell">CON</div> </div> <div class="row"> <div class="cell">Bronze</div> <div class="cell">Elétrico</div> <div class="cell">Linha - 1.5m/9m</div> <div class="cell">DES</div> </div> <div class="row"> <div class="cell">Cobre</div> <div class="cell">Ácido</div> <div class="cell">Linha - 1.5m/9m</div> <div class="cell">DES</div> </div> <div class="row"> <div class="cell">Latão</div> <div class="cell">Fogo</div> <div class="cell">Linha - 1.5m/9m</div> <div class="cell">DES</div> </div> <div class="row"> <div class="cell">Negro</div> <div class="cell">Fogo</div> <div class="cell">Linha - 1.5m/9m</div> <div class="cell">DES</div> </div> <div class="row"> <div class="cell">Ouro</div> <div class="cell">Fogo</div> <div class="cell">Cone - 4.5m</div> <div class="cell">CON</div> </div> <div class="row"> <div class="cell">Prata</div> <div class="cell">Gelo</div> <div class="cell">Cone - 4.5m</div> <div class="cell">CON</div> </div> <div class="row"> <div class="cell">Verde</div> <div class="cell">Veneno</div> <div class="cell">Cone - 4.5m</div> <div class="cell">CON</div> </div> <div class="row"> <div class="cell">Vermelho</div> <div class="cell">Veneno</div> <div class="cell">Cone - 4.5m</div> <div class="cell">CON</div> </div></div>'
            break;
        case 'dwarf':
            raceTitle = 'Anão';
    ...
    raceDescriptionDiv.innerHTML = `<h2>${raceTitle}</h2><p>${raceDescription}</p><p>${racetable}</p>`;
});

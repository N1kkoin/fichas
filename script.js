...
const translationsPT = {
    title: "Ficha de Personagem D&D (em construção)",
    charname: "Nome",
  ...
  function updateUI() {
    ...
    elements.forEach(element => {
      ...
      element.textContent = currentLanguage === "pt" ? translationsPT[key] : translationsEN[key];
    });
  }
  ...
  // Inicialize a interface com o idioma padrão
  updateUI();
  
  const languageToggle = document.getElementById('language-toggle');

  // Obtém a linguagem do navegador do usuário
  const userLanguage = navigator.language || navigator.userLanguage;

  // Define o idioma padrão com base na linguagem do usuário
  let isEnglish = userLanguage.toLowerCase().startsWith('en'); // Se começar com 'en', assume inglês, caso contrário, assume português

  // Função para alternar o idioma do botão
  function toggleLanguage() {
      ...
      if (isEnglish) {
          ...
          languageToggle.textContent = 'Mudar Linguagem';
      }
  }

  // Adiciona um ouvinte de evento de clique para alternar o idioma quando o botão for clicado
  languageToggle.addEventListener('click', toggleLanguage);

  // Define o texto inicial do botão com base na linguagem padrão
  window.addEventListener('load', function () {
      toggleLanguage();
  });